		...
		_createStyleSelect : function(n) {
			...
			ctrl = ctrlMan.createListBox('styleselect', {
				...
				onselect : function(name) {
					var matches, formatNameFiles = [], removedFormat;

					each(ctrl.items, function(item) {
						formatNameFiles.push(item.value);
					});
					...
					matches = ed.formatter.matchAll(formatNameFiles);
...
*/
		...
		_nodeChanged : function(ed, cm, n, co, ob) {
			var t = this, p, de = 0, v, c, s = t.settings, cl, fz, fn, fc, bc, formatNameFiles, matches;
