<script type="text/javascript">
	tinyMCE.init({
		...
		// Advanced theme
		theme_advanced_buttons1 : "bold,italic,underline,strikethrough,|,styleselect,|,link, unlink,|,",		
//theme_advanced_buttons1 : "bold,italic,underline,strikethrough,|,styleselect,fontsizeselect,|,link, unlink,|,",CON TAMAÑOS
		theme_advanced_buttons1_add : "bullist,numlist,separator,undo,redo,|,table,removeformat,code",
	  //  theme_advanced_buttons3 : "hr,removeformat,visualaid,separator,sub,sup,separator,charmap",
		...
		theme_advanced_font_sizes : "XXL=7em,XL=3.2em,L=2.3em,M=1.8em,S=1.2em",
//	 	theme_advanced_font_sizes : "Promoción=4em,Grande=3em,Mediana=2em,Pequeña=1em",
		theme_advanced_toolbar_align : "left",
		theme_advanced_source_editor_height : "150",
