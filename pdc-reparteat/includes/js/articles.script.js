...
function changeAction() {
	document.getElementById('mainform').action='modules/articles/create_record.php?add_p=ON';	
}

function optionAction(action, id) {
	document.getElementById('mainform').action='modules/articles/edit_record.php?record='+id+'&option='+action;
}

function optionActionBlock(action, id, block) {
	document.getElementById('mainform').action='modules/articles/edit_record.php?record='+id+'&option='+action+'&block='+block;
}
function optionActionFile(action, id, file) {
	document.getElementById('mainform').action='modules/articles/edit_record.php?record='+id+'&option='+action+'&file='+file;
}
function open_thumb_new() {
	...
	document.getElementById('box_article').style.height='550px';
}
function close_thumb_new() {
	...
	document.getElementById('box_article').style.height='470px';
}
...
/*función mostrar dimensiones al crear un artículo*/
...
/*función mostrar dimensiones al editar un artículo*/
function showDimensionEditArticle(aux){
