...
?>
	...
	<div class='cp_mnu_title title_header_mod'>Listado de categorias de productos</div>
	<div class='container container-admin'>
		...
		<div id="wrap-addCategory" class="form-category">
			<form method='post' action='modules/product/create_category.php' enctype='multipart/form-data' id='mainform' name='mainform'>
	...
	<?php if (isset($_GET['msg'])){ ?>
		...
		<br/>
	<?php }
		include ("components/product/product.list.category.php");
}else{
