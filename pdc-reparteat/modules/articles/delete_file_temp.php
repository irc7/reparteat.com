...
if (allowed("content")) {
	...
	$dir6 = "../../../files/articles_temp/newsletter/";
	...
	$images_newsletter = opendir($dir6);
	while ($file_newsletter = readdir($images_newsletter))  {   
		if (is_file($dir6.$file_newsletter)) { 
			unlink($dir6.$file_newsletter); 
		}
	}
...
//	}
	...
	if(!isset($_GET["return"])) {
		$location = "Location: ../../index.php?mnu=content&com=articles&tpl=trash&msg=".utf8_decode($msg);
	}else{
