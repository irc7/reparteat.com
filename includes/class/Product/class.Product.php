...
class Product extends System {
	...
	public function productImages($id = null) {
		...
		$q = "select * from ".preBD."product_images where true and IDASSOC = " . $id . " and TYPE = 'product' order by POSITION asc";
		$r = checkingQuery($connectBD, $q);
	...
	public function infoProductById($id = null) {
		...
		$q = "select * from ".preBD."products where true and ID = '" . $id . "' and STATUS = 1";
		$r = checkingQuery($connectBD, $q);
	...
	public function listProductBySupplier($id = null) {
		...
		$q = "select ".preBD."products.*,
				...
				order by ".preBD."products.POSITION asc, ".preBD."products.DATE_START desc";
		$r = checkingQuery($connectBD, $q);
	...
	public function listProductBySupplierAll($id = null) {
		global $connectBD;
		...
		$q = "select ".preBD."products.*,
				...
				inner join ".preBD."url_web 
				on ".preBD."url_web.ID_VIEW = ".preBD."products.ID and ".preBD."url_web.TYPE = 'product'
				where true and ".preBD."products.IDSUPPLIER = " . $id;
		$r = checkingQuery($connectBD, $q);
		$data = array();
		while($row = mysqli_fetch_object($r)) {
			$data[] = $row;
	...
	public function listProductBySupplierAllPosition($id = null) {
		global $connectBD;
		...
		$q = "select ".preBD."products.*,
				...
				inner join ".preBD."url_web 
				on ".preBD."url_web.ID_VIEW = ".preBD."products.ID and ".preBD."url_web.TYPE = 'product'
				where true and ".preBD."products.IDSUPPLIER = " . $id . " order by POSITION asc, DATE_START desc";
		$r = checkingQuery($connectBD, $q);
		$data = array();
		while($row = mysqli_fetch_object($r)) {
			$data[] = $row;
	...
	public function productComs($id = null) {
		global $connectBD;
		...
		$q = "select ".preBD."products_com.ID, 
				...
				on ".preBD."products_com.ID = ".preBD."products_com_assoc.IDCOM 
				and ".preBD."products_com_assoc.IDPRODUCT = ".$id."
				where true order by ".preBD."products_com_assoc.TYPE asc, ".preBD."products_com.TITLE asc";
		$r = checkingQuery($connectBD, $q);
		$auxData = array();
		while($data = mysqli_fetch_object($r)) {
			$auxData[] = $data;
	...
	public function infoCategories($id = null) {
		...
		$q = "select ".preBD."products_cat.*
				from ".preBD."products_cat
				inner join ".preBD."products_cat_assoc on ".preBD."products_cat_assoc.IDCAT = ".preBD."products_cat.ID and ".preBD."products_cat_assoc.IDPRODUCT = ".$id."
				where true order by ".preBD."products_cat.TITLE asc";
		$r = checkingQuery($connectBD, $q);
