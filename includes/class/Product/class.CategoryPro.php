...
class CategoryPro extends System {
	...
	public function allCategoriesSupplier($idSup) {
		global $connectBD;
		
		$q = "SELECT ".preBD."products_cat.* 
			FROM ".preBD."products_cat_assoc 
			inner join ".preBD."products_cat on ".preBD."products_cat.ID = ".preBD."products_cat_assoc.IDCAT
			inner join ".preBD."products on ".preBD."products.ID = ".preBD."products_cat_assoc.IDPRODUCT and ".preBD."products.IDSUPPLIER = " . $idSup . "
			where true group by ".preBD."products_cat_assoc.IDCAT";
		$r = checkingQuery($connectBD, $q);
