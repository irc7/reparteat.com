...
function goo_gl_short_url($longUrl) {     
	$GoogleApiKey = 'AIzaSyBMB8vg-oy-h_NgXe3poXF5UUCsdeAGqI0';     
	
	$api = new GoogleURL($GoogleApiKey);
	return $api->encode($longUrl);
...
class GoogleURL { 
	...
	//convierte una url larga en una corta public 
	function encode($url) { 
